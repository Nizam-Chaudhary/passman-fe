...
export const getPostApiV1AuthSignUpUrl = () => {
  return `https://api.passman.live/api/v1/auth/sign-up`;
};
...
export const postApiV1AuthSignUp = async (
  ...
  const res = await fetch(getPostApiV1AuthSignUpUrl(), {
    ...options,
    method: "POST",
  ...
  const data: PostApiV1AuthSignUp200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  > = (props) => {
    ...
    return postApiV1AuthSignUp(data, fetchOptions);
  };
...
export const getPostApiV1AuthSignInUrl = () => {
  return `https://api.passman.live/api/v1/auth/sign-in`;
};
...
export const postApiV1AuthSignIn = async (
  ...
  const res = await fetch(getPostApiV1AuthSignInUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: PostApiV1AuthSignIn200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  > = (props) => {
    ...
    return postApiV1AuthSignIn(data, fetchOptions);
  };
...
export const getPostApiV1AuthRefreshTokenUrl = () => {
  return `https://api.passman.live/api/v1/auth/refresh-token`;
};
...
export const postApiV1AuthRefreshToken = async (
  ...
  const res = await fetch(getPostApiV1AuthRefreshTokenUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: PostApiV1AuthRefreshToken200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  > = (props) => {
    ...
    return postApiV1AuthRefreshToken(data, fetchOptions);
  };
...
export const getPatchApiV1AuthVerifyUrl = () => {
  return `https://api.passman.live/api/v1/auth/verify`;
};
...
export const patchApiV1AuthVerify = async (
  ...
  const res = await fetch(getPatchApiV1AuthVerifyUrl(), {
    ...options,
    method: "PATCH",
    headers: { "Content-Type": "application/json", ...options?.headers },
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: PatchApiV1AuthVerify200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  > = (props) => {
    ...
    return patchApiV1AuthVerify(data, fetchOptions);
  };
...
export const getPatchApiV1AuthCreateMasterKeyUrl = () => {
  return `https://api.passman.live/api/v1/auth/create-master-key`;
};
...
export const patchApiV1AuthCreateMasterKey = async (
  ...
  const res = await fetch(getPatchApiV1AuthCreateMasterKeyUrl(), {
    ...options,
    method: "PATCH",
    headers: { "Content-Type": "application/json", ...options?.headers },
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: PatchApiV1AuthCreateMasterKey200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  > = (props) => {
    ...
    return patchApiV1AuthCreateMasterKey(data, fetchOptions);
  };
...
export const getPostApiV1AuthVerifyMasterPasswordUrl = () => {
  return `https://api.passman.live/api/v1/auth/verify-master-password`;
};
...
export const postApiV1AuthVerifyMasterPassword = async (
  ...
  const res = await fetch(getPostApiV1AuthVerifyMasterPasswordUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: PostApiV1AuthVerifyMasterPassword200 = body
    ? JSON.parse(body)
    : {};
...
> => {
  ...
  > = (props) => {
    ...
    return postApiV1AuthVerifyMasterPassword(data, fetchOptions);
  };
...
export const getPostApiV1AuthResendOtpUrl = () => {
  return `https://api.passman.live/api/v1/auth/resend-otp`;
};
...
export const postApiV1AuthResendOtp = async (
  ...
  const res = await fetch(getPostApiV1AuthResendOtpUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: PostApiV1AuthResendOtp200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  > = (props) => {
    ...
    return postApiV1AuthResendOtp(data, fetchOptions);
  };
...
export const getPostApiV1AuthResetPasswordMailUrl = () => {
  return `https://api.passman.live/api/v1/auth/reset-password-mail`;
};
...
export const postApiV1AuthResetPasswordMail = async (
  ...
  const res = await fetch(getPostApiV1AuthResetPasswordMailUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: PostApiV1AuthResetPasswordMail200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  > = (props) => {
    ...
    return postApiV1AuthResetPasswordMail(data, fetchOptions);
  };
...
export const getPatchApiV1AuthResetPasswordUrl = () => {
  return `https://api.passman.live/api/v1/auth/reset-password`;
};
...
export const patchApiV1AuthResetPassword = async (
  ...
  const res = await fetch(getPatchApiV1AuthResetPasswordUrl(), {
    ...options,
    method: "PATCH",
    headers: { "Content-Type": "application/json", ...options?.headers },
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: PatchApiV1AuthResetPassword200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  > = (props) => {
    ...
    return patchApiV1AuthResetPassword(data, fetchOptions);
  };
...
export const getPatchApiV1AuthMasterPasswordUrl = () => {
  return `https://api.passman.live/api/v1/auth/master-password`;
};
...
export const patchApiV1AuthMasterPassword = async (
  ...
  const res = await fetch(getPatchApiV1AuthMasterPasswordUrl(), {
    ...options,
    method: "PATCH",
    headers: { "Content-Type": "application/json", ...options?.headers },
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: PatchApiV1AuthMasterPassword200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  > = (props) => {
    ...
    return patchApiV1AuthMasterPassword(data, fetchOptions);
  };
...
export const getPostApiV1FilesUploadUrl = () => {
  return `https://api.passman.live/api/v1/files/upload`;
};

export const postApiV1FilesUpload = async (
  options?: RequestInit
): Promise<PostApiV1FilesUpload200> => {
  const res = await fetch(getPostApiV1FilesUploadUrl(), {
    ...options,
    method: "POST",
  });

  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: PostApiV1FilesUpload200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  const mutationFn: MutationFunction<
    ...
    void
  > = () => {
    return postApiV1FilesUpload(fetchOptions);
  };
...
export const getGetHealthUrl = () => {
  return `https://api.passman.live/health/`;
};
...
export const getGetHealthQueryKey = () => {
  return [`https://api.passman.live/health/`] as const;
};
...
export const getPostApiV1PasswordsUrl = () => {
  return `https://api.passman.live/api/v1/passwords/`;
};
...
export const postApiV1Passwords = async (
  ...
  const res = await fetch(getPostApiV1PasswordsUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: PostApiV1Passwords200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  > = (props) => {
    ...
    return postApiV1Passwords(data, fetchOptions);
  };
...
export const getGetApiV1PasswordsUrl = (params: GetApiV1PasswordsParams) => {
  ...
  return normalizedParams.size
    ? `https://api.passman.live/api/v1/passwords/?${normalizedParams.toString()}`
    : `https://api.passman.live/api/v1/passwords/`;
};
...
export const getApiV1Passwords = async (
  ...
  const res = await fetch(getGetApiV1PasswordsUrl(params), {
    ...options,
    method: "GET",
  });

  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: GetApiV1Passwords200 = body ? JSON.parse(body) : {};
...
>(
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getApiV1Passwords>>
  > = ({ signal }) => getApiV1Passwords(params, { signal, ...fetchOptions });
...
export const getGetApiV1PasswordsIdUrl = (id: number) => {
  return `https://api.passman.live/api/v1/passwords/${id}`;
};
...
export const getApiV1PasswordsId = async (
  ...
  const res = await fetch(getGetApiV1PasswordsIdUrl(id), {
    ...options,
    method: "GET",
  });

  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: GetApiV1PasswordsId200 = body ? JSON.parse(body) : {};

  return data;
};

export const getGetApiV1PasswordsIdQueryKey = (id: number) => {
  return [`https://api.passman.live/api/v1/passwords/${id}`] as const;
};
...
>(
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getApiV1PasswordsId>>
  > = ({ signal }) => getApiV1PasswordsId(id, { signal, ...fetchOptions });
...
export const putApiV1PasswordsId = async (
  ...
  const res = await fetch(getPutApiV1PasswordsIdUrl(id), {
    ...options,
    method: "PUT",
    headers: { "Content-Type": "application/json", ...options?.headers },
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: PutApiV1PasswordsId200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  > = (props) => {
    ...
    return putApiV1PasswordsId(id, data, fetchOptions);
  };
...
export const deleteApiV1PasswordsId = async (
  ...
  const res = await fetch(getDeleteApiV1PasswordsIdUrl(id), {
    ...options,
    method: "DELETE",
  });

  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: DeleteApiV1PasswordsId200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  > = (props) => {
    ...
    return deleteApiV1PasswordsId(id, fetchOptions);
  };
...
export const getPostApiV1PasswordsImportUrl = () => {
  return `https://api.passman.live/api/v1/passwords/import`;
};
...
export const postApiV1PasswordsImport = async (
  ...
  const res = await fetch(getPostApiV1PasswordsImportUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: PostApiV1PasswordsImport200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  > = (props) => {
    ...
    return postApiV1PasswordsImport(data, fetchOptions);
  };
...
export const getPatchApiV1UsersUrl = () => {
  return `https://api.passman.live/api/v1/users/`;
};
...
export const patchApiV1Users = async (
  ...
  const res = await fetch(getPatchApiV1UsersUrl(), {
    ...options,
    method: "PATCH",
    headers: { "Content-Type": "application/json", ...options?.headers },
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: PatchApiV1Users200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  > = (props) => {
    ...
    return patchApiV1Users(data, fetchOptions);
  };
...
export const getApiV1Users = async (
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: GetApiV1Users200 = body ? JSON.parse(body) : {};

  return data;
};

export const getGetApiV1UsersQueryKey = () => {
  return [`https://api.passman.live/api/v1/users/`] as const;
};
...
>(options?: {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiV1Users>>> = ({
    signal,
  }) => getApiV1Users({ signal, ...fetchOptions });
...
export const getGetApiV1VaultsUrl = () => {
  return `https://api.passman.live/api/v1/vaults/`;
};

export const getApiV1Vaults = async (
  options?: RequestInit
): Promise<GetApiV1Vaults200> => {
  const res = await fetch(getGetApiV1VaultsUrl(), {
    ...options,
    method: "GET",
  });

  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: GetApiV1Vaults200 = body ? JSON.parse(body) : {};

  return data;
};

export const getGetApiV1VaultsQueryKey = () => {
  return [`https://api.passman.live/api/v1/vaults/`] as const;
};
...
>(options?: {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiV1Vaults>>> = ({
    signal,
  }) => getApiV1Vaults({ signal, ...fetchOptions });
...
export const postApiV1Vaults = async (
  ...
  const res = await fetch(getPostApiV1VaultsUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: PostApiV1Vaults200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  > = (props) => {
    ...
    return postApiV1Vaults(data, fetchOptions);
  };
...
export const getPutApiV1VaultsIdUrl = (id: number) => {
  return `https://api.passman.live/api/v1/vaults/${id}`;
};
...
export const putApiV1VaultsId = async (
  ...
  const res = await fetch(getPutApiV1VaultsIdUrl(id), {
    ...options,
    method: "PUT",
    headers: { "Content-Type": "application/json", ...options?.headers },
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: PutApiV1VaultsId200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  > = (props) => {
    ...
    return putApiV1VaultsId(id, data, fetchOptions);
  };
...
export const deleteApiV1VaultsId = async (
  ...
  const res = await fetch(getDeleteApiV1VaultsIdUrl(id), {
    ...options,
    method: "DELETE",
  });

  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: DeleteApiV1VaultsId200 = body ? JSON.parse(body) : {};
...
> => {
  ...
  > = (props) => {
    ...
    return deleteApiV1VaultsId(id, fetchOptions);
  };
